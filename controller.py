...
def run_controller_policy(initial_temp):
    ...
    while True:
        ...
        value_list = []
        value_re = 0
        value1 = list(rs.get_points(tags={'name':'user1'}))[-1]['temperature']
        value2 = list(rs.get_points(tags={'name':'user1'}))[-2]['temperature']
        value3 = list(rs.get_points(tags={'name':'user1'}))[-3]['temperature']
...
DEVICE = {
    ...
    1 : 550, # plugwise name of Fan Heater 2, 3 D36928 
    2 : 469, # plugwise name of Fan Heater 5, 6, D359E6 
